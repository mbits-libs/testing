...
set(PROJECT_GTEST_MAIN_CC_WITH_DATA_PATH "${CMAKE_CURRENT_LIST_DIR}/googletest.cpp")
set(PROJECT_GTEST_MAIN_CC "${CMAKE_CURRENT_LIST_DIR}/gtest/googlemock/src/gmock_main.cc")
...
function(add_test_executable TARGET)
	...
	if (TEST_EXE_NO_DATA)
		set(TEST_EXE_GTEST_MAIN_CC ${PROJECT_GTEST_MAIN_CC})
	else()
		set(TEST_EXE_GTEST_MAIN_CC ${PROJECT_GTEST_MAIN_CC_WITH_DATA_PATH})
